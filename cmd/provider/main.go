...
import (
	...
	"github.com/dunkin0486/provider-azuredevops/apis"
	azuredevops "github.com/dunkin0486/provider-azuredevops/internal/controller"
	"github.com/dunkin0486/provider-azuredevops/internal/version"
)

func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "AzureDevOps support for Crossplane.").DefaultEnvars()
	...
	kingpin.FatalIfError(apis.AddToScheme(scheme), "Cannot add AzureDevOps APIs to scheme")
	...
	kingpin.FatalIfError(azuredevops.SetupGated(mgr, o), "Cannot setup AzureDevOps controllers")
