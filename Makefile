...
PROJECT_REPO := github.com/dunkin0486/$(PROJECT_NAME)
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider AzureDevOps CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider AzureDevOps controllers
